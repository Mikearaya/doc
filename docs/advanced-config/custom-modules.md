...
In many cases this goes together with [extending the API](./extending-schema) to include additional mutations and queries that access the module's functions.
